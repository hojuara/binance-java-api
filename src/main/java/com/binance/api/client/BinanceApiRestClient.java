...
public interface BinanceApiRestClient {
     ...
     *
     * If both <code>startTime</code> and <code>endTime</code> are sent,
     * <code>limit</code>should not
     * be sent AND the distance between <code>startTime</code> and
     ...
     * @param assets
     */
    DustConversionInfo convertDust(List<String> assets);
     ...
     * @return
     */
    String getMarketCap(String symbol);
}
